			...
			if ($.isFunction(self.options.down.callback)) {
				self.pullDownTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="mui-pull-top-wrapper" style="z-Index:100;"><div class="mui-pull-top-canvas"><canvas id="pullDownTips" width="' + self.options.down.tips.size + '" height="' + self.options.down.tips.size + '"></canvas></div></div>';
